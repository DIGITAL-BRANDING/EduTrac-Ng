...
const _SVG = {
  ...
  elearning:    '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></svg>',
  curriculum:   '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>',
  ...
  scheme:       '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>',
...
const _ADMIN_GROUPS = [
  ...
  { type:'group', id:'grp-staff-portals', icon:'<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>', label:'Staff Activities',
    children:[
      ...
      { id:'sp-bursar',      icon:_SVG.money,     label:'Bursary Portal',      href:'#', onclick:'openImpersonateModal(\'bursar\',\'../portals/bursary/index.html\')' },
    ]
  },
  ...
  // ─ E-Learning ─
  { type:'group', id:'grp-elearning', icon:_SVG.elearning, label:'E-Learning',
    children:[
      { id:'e-learning',  icon:_SVG.monitor,    label:'Learning Portal',    href:'e-learning.html' },
      { id:'e-library',   icon:_SVG.book,       label:'eLibrary Resources', href:'e-library.html' },
      { id:'cbt-center',  icon:_SVG.cbt,        label:'CBT Practice Center',href:'e-learning.html' },
    ]
  },

  // ─ Curriculum ─
  { type:'group', id:'grp-curriculum', icon:_SVG.curriculum, label:'Curriculum',
    children:[
      { id:'curriculum',    icon:_SVG.curriculum, label:'Curriculum Portal',  href:'curriculum.html' },
      { id:'lesson-plans',  icon:_SVG.scheme,     label:'Lesson Plans',       href:'curriculum.html' },
      { id:'scheme-of-work',icon:_SVG.book,       label:'Scheme of Work',     href:'curriculum.html' },
      { id:'lesson-notes',  icon:_SVG.lessonNote, label:'Lesson Note AI ✨',   href:'lesson-notes.html' },
    ]
  },
];
      ...
      <div class="nav-group${isOpen ? ' open' : ''}${hasActive ? ' active-group' : ''}" id="${item.id}">
        ...
        <div class="nav-group__body">
          ${item.children.map(c => {
            ...
            if (c.onclick) {
              return `<a href="${c.href}" onclick="${c.onclick};return false;" class="nav-item nav-item--child${isCActive ? ' active' : ''}">
